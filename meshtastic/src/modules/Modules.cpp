...
// FOR EXAMPLE:
//#include "modules/GECKOBCustomTemplate.h"

#include "modules/GECKOBBME280.cpp"
...
void setupModules()
{
    ...
    // add the custom components here
    
    // FOR EXAMPLE:
    //geckob_custom_template = new GECKOBCustomTemplate();

    geckob_custom_bme280 = new BME280Module();
